...
app.get("/inventory/:productId", async (req, res) => {
  ...
  if (!record)
    return res
      .status(404)
      .json({ productId: req.params.productId, quantity: 0 });
  res.json(record);
});
...
// mongodb+srv://moebooka33:<db_password>@cluster0.zpbvbvx.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0
